...
class HealthVisitActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_health_visit)
        ...
        var uploadStatusImageBtn = findViewById<MaterialButton>(R.id.uploadStatusImageButton)
        uploadStatusImageBtn.setOnClickListener {
